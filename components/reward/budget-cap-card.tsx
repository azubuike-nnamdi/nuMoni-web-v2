...
export default function BudgetCapCard({ rewardCap, isLoading }: Readonly<BudgetCapCardProps>) {
  if (isLoading) {
    return <CardSkeleton variant="gradient" />;
  }

  return (
    <div className="relative overflow-hidden bg-linear-to-br from-green-800 to-green-900 text-white rounded-xl p-6 flex flex-col h-full">
