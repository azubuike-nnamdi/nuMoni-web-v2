...
import useGetAllPosByMerchantId from "@/hooks/query/useGetAllPosByMercantId";
...
export default function UnauthExportPOS({ isOpen, onClose, posId, merchantId }: Readonly<ExportPOSProps>) {

  const { isPending: isLoadingPos, data: posData, error, isError } = useGetAllPosByMerchantId(merchantId ?? "");
